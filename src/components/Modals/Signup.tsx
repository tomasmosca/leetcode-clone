    ...
    return <form className='mt-3 px-8 pb-4' onSubmit={handleRegister}>
        ...
        <div>
            <div className='mt-4'>
                ...
                <input onChange={handleInputChange} className='rounded-md w-full h-9 mt-1 p-2.5 text-sm outline-none bg-zinc-700 text-white placeholder-zinc-400' type='email' name='email' id='email' placeholder='johndoe@gmail.com' autoComplete='off'/>
            </div>
            <div className='mt-4'>
                <label htmlFor='displayName' className='text-zinc-800 font-light text-sm block'>Display Name</label>
                <input onChange={handleInputChange} className='rounded-md w-full h-9 mt-1 p-2.5 text-sm outline-none bg-zinc-700 text-white placeholder-zinc-400' type='displayName' name='displayName' id='displayName' placeholder='John Doe' autoComplete='off'/>
            </div>
            <div className='mt-4'>
                <label htmlFor='password' className='text-zinc-800 font-light text-sm block'>Password</label>
                <input onChange={handleInputChange} className='rounded-md w-full h-9 mt-1 p-2.5 text-sm outline-none bg-zinc-700 text-white placeholder-zinc-400' type='password' name='password' id='password' placeholder='password' autoComplete='off'/>
            </div>
