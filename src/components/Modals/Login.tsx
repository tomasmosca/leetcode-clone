    ...
    return <form className='mt-3 px-8 pb-4'>
        ...
        <div>
            ...
            <div className='flex w-full justify-end mt-4'>
                <a href='#' className='text-zinc-800 text-sm font-normal hover:underline'>Forgot Password?</a>
            </div>
            <div className='mt-3'>
                <label className='text-sm'>Not registered?<a href='#' className='text-blue-700 ml-1 hover:underline'>Create account</a></label>
            </div>
        </div>
    </form>
}
